...
ax.plot(t,median(R[3,:,:],dims=2)/cerr,"k",label="Float16")
ax.plot(t,median(R[5,:,:],dims=2)/cerr,"#50C070",ls="--",label="Posit(16,1)")
ax.plot(t,median(R[6,:,:],dims=2)/cerr,"#900000",ls="--",label="Posit(16,2)")
ax.plot(t,median(R[8,:,:],dims=2)/cerr,"grey",ls="-.",label="BFloat16/Float32")
ax.plot(t,median(R[7,:,:],dims=2)/cerr,"C1",ls="-.",label="Float16/Float32")

ax.fill_between(t,Rp[1,3,:]/cerr,Rp[2,3,:]/cerr,color="k",alpha=0.2)
...
ax.fill_between(t,Rp[1,8,:]/cerr,Rp[2,8,:]/cerr,color="grey",alpha=0.2)
ax.fill_between(t,Rp[1,7,:]/cerr,Rp[2,7,:]/cerr,color="C1",alpha=0.2)
