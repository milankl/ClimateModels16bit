...
\caption{Entropy of mixing calculated from the tracer concentration simulated with various 16bit number formats. Lines represent the mean of 50 forecasts per number format. The entropy is normalized by the entropy of a homogeneous tracer. The shaded area denotes the ensemble spread of the reference simulation with Float64. Note the cubically scaled y-axis.}
\label{fig:entropy}
\end{figure}
