...
\end{verbatim}
\caption{A type-stable harmonic sum function in the Julia language.}
\label{fig:emulator}
\end{figure}
...
julia> harmonic_sum(Float16,2000)
(7.0859375, 513)
julia> harmonic_sum(BFloat16,2000)
(5.0625, 65)
julia> harmonic_sum(Posit16,2000)    # Posit16 is the Posit(16,1) standard
(7.77734375, 1024)
\end{verbatim}
\caption{Harmonic sum example use of the posit emulator \emph{SoftPosit.jl} in the Julia shell.}
\label{fig:emulator}
\end{figure}
